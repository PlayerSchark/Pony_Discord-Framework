 ...
 */
public class PonyPublicCommand extends PonyCommand {

	public PonyPublicCommand(IMentionable sender, Message message, MessageChannel channel, PonyLabel label, List<PonyArg> args) {
