...
public class PonyGuildCommandInfo extends PonyDiscordCommandInfo<PonyGuildCommandExecutable> {
	...
	public PonyGuildCommandInfo(PonyGuildCommandExecutable executable, Set<Long> allowedRoles, Set<Long> allowedUsers, Set<Long> allowedGuilds, Set<Long> allowedChannels, boolean botUsable,
